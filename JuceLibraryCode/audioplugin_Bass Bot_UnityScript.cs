...
public class audioplugin_Bass_BotGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_Bass Bot"; } }
    public override string Description    { get { return "Bass Bot"; } }
    public override string Vendor         { get { return "Audio Bots"; } }

    //==============================================================================
    [DllImport("audioplugin_Bass Bot")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_Bass Bot")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_Bass Bot")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_Bass Bot")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_Bass Bot")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_Bass Bot")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_Bass Bot")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
